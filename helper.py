...
descriptions = {
    ...
    "depechehouse": "A social app which allows users to create accounts using email, password and usernames. Users are able to post messages to a global feed which can be seen by all other users. Users can edit or delete their posts, change their profile picture, uesrname and password. This projects showcases advanced flask functions.", 
    ...
    "mileagecalculator": "This was the first project I made. This used pure Python and could only be used in a CLI. Enter your current car mileage into the terminal and the calculator will update your CSV file with different information."
    }
...
goals = {
    ...
    "depechecodes":["A simple flask app to feature my work", "Learn basic front-end techniques using bootstrap"], 
    "mileagecalculator": ["Putting my knowledge of Python into practice for the first time", "Learning to use the terminal", "Reading and writing to CSV"]
    }

github_links = {
    "eisenhowersquadrant": "https://github.com/Sam-Ian/Eisenhowers-Quadrant/", 
    "depechehouse": "https://github.com/Sam-Ian/Depeche-House/", 
    "depechecodes": "https://github.com/Sam-Ian/Depeche-Codes", 
...
project_images = {
    "eisenhowersquadrant": "background-image: url(../static/images/quadrants.jpg)", 
    "depechehouse": "background-image: url(../static/images/house.jpg)", 
    "depechecodes": "background-image: url(../static/images/pawel-czerwinski-ISgDx2aOAB8-unsplash.jpg)", 
    "mileagecalculator": "background-image: url(../static/images/tesla.jpg)"
    }
